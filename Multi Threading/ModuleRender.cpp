...
bool ModuleRender::init()
{
	...
	auto vertexShaderBytecode = LoadShaderFile("vertex_shader.hlsl");
	ID3DBlob *errorBlob = NULL;

	D3DCompile(&vertexShaderBytecode[0], vertexShaderBytecode.size(), NULL, NULL, NULL, "main", "vs_4_0", 0, 0, &g_pVertexShaderBlob, &errorBlob);
	if (errorBlob) {
	...
	auto pixelShaderBytecode = LoadShaderFile("pixel_shader.hlsl");

	D3DCompile(&pixelShaderBytecode[0], pixelShaderBytecode.size(), NULL, NULL, NULL, "main", "ps_4_0", 0, 0, &g_pPixelShaderBlob, &errorBlob);
	if (errorBlob) {
